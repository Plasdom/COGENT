#include "MaxwellianKineticFunctionRL.H"
...
MaxwellianKineticFunctionRL::MaxwellianKineticFunctionRL( ParmParse& a_pp,
...
void MaxwellianKineticFunctionRL::assign( KineticSpecies& a_species,
...
void MaxwellianKineticFunctionRL::assign( KineticSpecies& a_species,
                                        ...
                                        const Real& a_time ) const
{
   CH_TIMERS("MaxwellianKineticFunctionRL::assign");
...
inline
void MaxwellianKineticFunctionRL::parseParameters( ParmParse& a_pp )
{
...
inline
void MaxwellianKineticFunctionRL::initializeField( LevelData<FArrayBox>& a_field,
...
inline
void MaxwellianKineticFunctionRL::initializeField( FArrayBox& a_field,
                                                 const CFG::GridFunction& a_ic,
                                                 ...
                                                 const Real& a_time ) const
{
   CH_TIMERS("MaxwellianKineticFunctionRL::initializeField");
...
inline
void MaxwellianKineticFunctionRL::checkGeometryValidity( const PhaseGeom& a_geometry ) const
{
   ...
   if ( unknown_geom ) {
      const std::string msg( "MaxwellianKineticFunctionRL: Attempt to use unknown geometry. ");
      MayDay::Error( msg.c_str() );
   }
}

inline
void MaxwellianKineticFunctionRL::setPointValues(
   FArrayBox&                a_dfn,
   const Box&                a_box,
...
{
   CH_TIME("MaxwellianKineticFunctionRL::setPointValues");

   FORT_SET_MAXWELL4D_RL( CHF_FRA(a_dfn),
                       CHF_BOX(a_box),
...
inline
void MaxwellianKineticFunctionRL::printParameters() const
{
   if (procID()==0) {
